...
const ListItem: React.FC<ListItemProps> = ({ textTitle, textContent, imageSrc }) => {
    return (
        <StyledListItem>
...
const StudyApplyList: React.FC<ApplyListProps> = ({ period, deadline, currentCount, headCount, studyLeader }) => {
    return (
        <ListContainer>
            <ListItem textTitle="진행기간" textContent={period} imageSrc="/study-icon-img.png" />
            <ListItem textTitle="모집마감" textContent={deadline} imageSrc="/study-icon-img.png" />
            <ListItem
                textTitle="모집인원"
                // 현재인원 / 모집인원
            ...
            />
            <ListItem textTitle="스터디장" textContent={studyLeader} imageSrc="/study-icon-img.png" />
        </ListContainer>
    );
};
