...
/** 1. 피드백, 댓글 작성  post */
export const postFeedback = async (content_type: number, content: string, study_id: string, token: string) => {
...
/** 4. 피드백, 댓글 수정  put */
export const putFeedbackByUserId = async (user_id: string, data: { content_type: number; content: string }) => {
...
/** 5. 피드백, 댓글 삭제  delete */
export const deleteFeedbackByUserId = async (study_id: string, token: string) => {
