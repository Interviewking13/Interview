...
const SignupPage = () => {
  ...
  return (
    <StyledLoginContainer>
      ...
      <StyledSignupContainer>
        <StyledSignupInput placeholder="이름" value={name} onChange={onChangeName} ></StyledSignupInput>
        <StyledSignupInput placeholder="연락처" value={phone} onChange={onChangePhone} ></StyledSignupInput>
        <StyledSignupInput placeholder="아이디" value={email} onChange={onChangeEmail} ></StyledSignupInput>
        <StyledSignupInput placeholder="비밀번호" value={password} onChange={onChangePassword} ></StyledSignupInput>
        <StyledSignupInput placeholder="비밀번호 확인" value={confirmPassword} onChange={onChangePasswordConfirm} ></StyledSignupInput>
        <StyledSignupBtn onClick={onClickSubmit}>신청하기</StyledSignupBtn>
      </StyledSignupContainer>
    </StyledLoginContainer>
  );
